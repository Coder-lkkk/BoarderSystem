...
<script>
	function regist(){
		$.ajax({
            type:"post",
            url:"<%=basePath%>login/regist.action",
            data:JSON.stringify({
            ...
            if(state==1){
            alert("注册成功" );
            	window.location.href = "<%=basePath%>login/toLogin.action"
            }else{
            alert("注册失败");
            	window.location.href = "<%=basePath%>login/toRegist.action"
            } 
            },
...
<div class="fly-header layui-bg-black">
  <div class="layui-container">
    <a class="fly-logo" href="<%=basePath%>login/toMain.action">
  ...
  <div class="fly-panel fly-panel-user" pad20>
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      <ul class="layui-tab-title">
        <li><a href="<%=basePath%>login/toLogin.action">登入</a></li>
          ...
          <div class="layui-form layui-form-pane">
            <form method="post">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="password" id="conf_password" name="repass" required lay-verify="required" autocomplete="off" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label id="vercode" for="L_vercode" class="layui-form-label">人类验证</label>
                <div class="layui-input-inline">
              ...
              <div class="layui-form-item">
                <button onclick="regist()" class="layui-btn" lay-filter="*" lay-submit>立即注册</button>
              </div>
